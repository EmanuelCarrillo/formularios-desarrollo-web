...
const validationSchema = yup.object({
  ...
  tarjeta: yup
    .string("Ingrese un número de tarjeta válido")
    .min(8, "Número de tarjeta válido")
    .required("No. de tarjeta requerido"),
  direccion: yup.string("Direccion").required("Direccion es requerida"),
  curso: yup.string("Curso").required("Curso es requerido"),
});
      ...
      >
        <div {...getToggleProps()}>
          <Typography variant="h4" style={{ marginBottom: "1%" }}>
            Informacion para asignacion de cursos
          </Typography>
        </div>
          ...
          <Grid container spacing={2} style={{ minHeight: "290px" }}>
            ...
            <Grid item xs={12} sm={6} md={4}>
              <TextField
                ...
                onChange={formik.handleChange}
                error={
                  formik.touched.tarjeta && Boolean(formik.errors.tarjeta)
                }
            ...
            <Grid item xs={12} sm={6} md={4}>
              <TextField
                ...
                id="curso"
                name="curso"
                label="Curso al cual se inscribibra"
                value={formik.values.curso}
                onChange={formik.handleChange}
                error={
                  formik.touched.curso && Boolean(formik.errors.curso)
                }
